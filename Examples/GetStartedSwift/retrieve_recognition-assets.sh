...
curl -O https://s3-us-west-2.amazonaws.com/iink/assets/1.2.0/myscript-iink-recognition-diagram.zip
unzip -o myscript-iink-recognition-diagram.zip -d $ProjectRootFolder/Resources/

curl -O https://s3-us-west-2.amazonaws.com/iink/assets/1.2.0/myscript-iink-recognition-raw-content.zip
unzip -o myscript-iink-recognition-raw-content.zip -d $ProjectRootFolder/Resources/

curl -O https://s3-us-west-2.amazonaws.com/iink/assets/1.2.0/myscript-iink-recognition-math.zip
unzip -o myscript-iink-recognition-math.zip -d $ProjectRootFolder/Resources/

curl -O https://s3-us-west-2.amazonaws.com/iink/assets/1.2.0/myscript-iink-recognition-text-en_US.zip
