...
curl -O https://download.myscript.com/iink/recognitionAssets_iink_4.1/myscript-iink-recognition-diagram.zip
unzip -o myscript-iink-recognition-diagram.zip -d $ProjectRootFolder/Resources/

curl -O https://download.myscript.com/iink/recognitionAssets_iink_4.1/myscript-iink-recognition-raw-content.zip
unzip -o myscript-iink-recognition-raw-content.zip -d $ProjectRootFolder/Resources/

curl -O https://download.myscript.com/iink/recognitionAssets_iink_4.1/myscript-iink-recognition-raw-content2.zip
unzip -o myscript-iink-recognition-raw-content2.zip -d $ProjectRootFolder/Resources/

curl -O https://download.myscript.com/iink/recognitionAssets_iink_4.1/myscript-iink-recognition-math.zip
unzip -o myscript-iink-recognition-math.zip -d $ProjectRootFolder/Resources/

curl -O https://download.myscript.com/iink/recognitionAssets_iink_4.1/myscript-iink-recognition-math2.zip
unzip -o myscript-iink-recognition-math2.zip -d $ProjectRootFolder/Resources/

curl -O https://download.myscript.com/iink/recognitionAssets_iink_4.1/myscript-iink-recognition-text-en_US.zip
